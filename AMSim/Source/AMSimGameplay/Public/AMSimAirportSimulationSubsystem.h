...
public:
	...
	AMSim::EPhase5CommandResult SubmitPhase5Command(AMSim::FPhase5Command Command);
	AMSim::EPhase6CommandResult SubmitPhase6Command(AMSim::FPhase6Command Command);
	...
	AMSim::FPhase5QuerySnapshot GetPhase5Query() const;
